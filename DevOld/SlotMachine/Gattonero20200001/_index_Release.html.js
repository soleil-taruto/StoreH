...
遊び方：<br/>
最初にレーンを選んで下さい。レーンによって絵柄の個数・割合が違います。番号が大きいほど接待向け。X はランダム。<br/>
----<br/>
RESET : ベットしたコインをゼロに戻します。<br/>
[00] : ここをタップするとコインをベットします。押しっぱなしで連続投入します。<br/>
AutoBet : 前回と同じ枚数コインを投入します。<br/>
START : ドラムの回転をスタートします。<br/>
STOP : 回転しているドラムを止めます。<br/>
EXIT : タイトルに戻ります。<br/>
